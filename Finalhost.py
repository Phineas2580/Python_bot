...
BOT_TOKEN = os.getenv("8717606762:AAGXYkSVws9XADKtaU5XaQ5outD5hot5xwI", "").strip()
if not BOT_TOKEN:
    raise RuntimeError("BOT_TOKEN is missing. Put it in .env; never hard-code it in source code.")
